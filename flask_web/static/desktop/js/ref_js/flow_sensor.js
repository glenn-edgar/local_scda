     ...
     var ajax_request = function()
     {
       ...
       ({
                    ...
                    error: function () 
		    {
                       ...
                       alert('/ajax/get_flow_queue.html'+"  Server Error Request Not Successful");
    ...
    var flow_sensor_request = function()
     {
            ...
            ({
                    type: "GET",
                    url: '/ajax/flow_sensor_name.html',
                    dataType: 'json',
                    async: false,
                    //json object to sent to the authentication url
                    data: [],
                    ...
                    error: function () 
		    {
                       ...
                       alert('/ajax/flow_sensor_name.html'+"  Server Error Request Not Successful");
