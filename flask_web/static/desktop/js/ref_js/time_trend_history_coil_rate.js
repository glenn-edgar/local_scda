...
*/
  ...
  function filter_graph_data(data)
  {
     ...
     if( data["limits"] != null )
     {
        limits_avg = data["limits"]["limit_avg"]
        std = data["limits"]["limit_std"]
     }
     else
     {
        limits_avg = 0
  ...
  function generate_graph()
   {
	    ...
	    json_object.index  = $("#Select_Index")[0].selectedIndex;
            ...
            $.ajax
            ({
                    url: '/ajax/get_coil_trend_data.html',
	            type: "GET",
                    dataType: 'json',
                    ...
                    error: function () 
		    {
                       ...
                       alert('/ajax/get_coil_trend_data.html'+"  Server Error Request Not Successful");
