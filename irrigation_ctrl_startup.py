...
if __name__ == "__main__":
   ...
   basic_io_control  = io_control.basic_io_control.BasicIo( redis_dict = redis_dict, redis_server=redis,  plc_interface=plc_map , 
   ...
   monitor           = Monitor(redis, basic_io_control, counter_devices, analog_devices, gpio_bit_input_devices,alarm_queue, ["127.0.0.1"] )
